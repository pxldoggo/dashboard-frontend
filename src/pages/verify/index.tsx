    ...
    <div className="flex justify-center flex-col-reverse gap-8 items-center w-screen h-screen">
      {!user.wallet ? (
        <>
          <button
            type="button"
            className="inline-flex items-center rounded-md border cursor-not-allowed border-transparent bg-indigo-400 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
          >
            Login with discord
          </button>
          <button
